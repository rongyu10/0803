...
while sim.flag && ishandle(fig)
    ...
    switch sim.mode 
        case 'RUN'
            ...
            [mycar, othercars] = update_control_mycar_IN_TTCandIDM_norfs(mycar, sim, othercars, idm, laneChangePath);
            
            % update speed and position of othercars (included merging and IDM)
            [othercars, mycar]  = update_control_othercars_mycar_IN_TTCandIDM_manual(othercars, sim, mycar, idm, laneChangePath, lengthP, FLAG_LANECHANGE);
