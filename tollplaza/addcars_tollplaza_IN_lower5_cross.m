function othercars = addcars_tollplaza_IN_lower5_cross(othercars, track, nr_cars)
...
for carid = 1:nr_cars
    if carid <= othercars.npl
       ...
       y = tmppos(2);
       carpos = [x y 0];
       othercars.car{carid}.goallane = randi(2)+13;
    ...
    elseif carid <= othercars.npl + 6
       ...
       othercars.car{carid}.goallane = randi(2)+10;
