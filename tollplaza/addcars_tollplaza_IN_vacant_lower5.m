function othercars = addcars_tollplaza_IN_vacant_lower5(othercars, track, nr_cars)
...
for carid = 1:nr_cars
    if carid <= othercars.npl
       ...
       x = (150-carid*60+20*rand)*10^3; 
       y = tmppos(2);
       carpos = [x y 0];
       othercars.car{carid}.goallane = 10 + randi(5);
    ...
    elseif carid <= othercars.npl + 6
       ...
       if carid <= othercars.npl + 6
           x = (150-(carid-othercars.npl)*60+20*rand)*10^3;
       end
       y = tmppos(2);
       carpos = [x y 0];
       othercars.car{carid}.goallane = 10 + randi(5);
       ...
       laneidx= 3;
       tmppos = get_posintrack(track, 1, 0, laneidx, 0);
       x = (150-(carid-(othercars.npl + 6))*60+20*rand)*10^3;
       y = tmppos(2);
       carpos = [x y 0];
