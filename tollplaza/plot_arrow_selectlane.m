function [h1, h2, h3] = plot_arrow_selectlane(selectlane)
...
if first_flag
    first_flag = false;
[h1, h2, h3] = plot_arrow([325*10^3 12250 - 3500*selectlane], 5000, 0, 'w', 3);
h.targetarrow = [h1 h2 h3];
else
    [x1, y1, x2, y2, x3, y3] = get_arrow([325*10^3 12250 - 3500*selectlane], 5000, 180, 'w', 3);
