...
for i = 1:othercars.n
    ...
    [idx_observedcar, t_observedcar, pos_mycarEst, pos_observedcarEst] = is_carcrashed_orFollow_forothercars_TTC_forwardrect(othercars, i, time_TTC, step_TTC, mycar, laneChangePath);    
...
%     % original--------------------------------------------------------------------------------------------
%     
%     if pos_mycarEst.flgPlaza == 0 % before entering plaza
%         
%         v0 = 15000;
%         
%         if othercars.car{i}.pos(1) > 0
%             [idx_observedcar, t_observedcar, pos_mycarEst, pos_observedcarEst] = is_carcrashed_orFollow_forothercars_TTC_forwardrect(othercars, idx, time_TTC, step_TTC, mycar)
%         end
%         
%         squareX = zeros(1,13);
%         squareY = zeros(1,13);
