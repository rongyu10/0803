...
if nargin==2
    ...
    if isempty(idx_nearCar)
       ...
       othercarBD = get_othercarBD(othercars,idx_nearCar,t);
...
if isempty(P)
    ...
    for i = 1:nr_cars
        lineData = get_carLineData(othercars.car{idx_nearCar(i)}.est{t}.bd);
...
function othercarBD = get_othercarBD(othercars,idx_nearCar,t)
