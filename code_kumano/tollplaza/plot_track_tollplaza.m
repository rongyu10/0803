function axisinfo = plot_track_tollplaza(road, FILL_LANES,varargin)
...
if (nargin == 3)
   PLOT_START_LINE = varargin{1}; 
else
   PLOT_START_LINE = true;  
end
        ...
        switch curr_type
            case 'straight'
                for j = 1:nr_lane - 1
                    ...
                    %a(1) 
                    %a(2)
                    %fill([a(1) b(1)], [a(2) b(2)], 'Color', 'c', 'LineWidth', 1); % test
                end
            case 'right_turn'
...
%----------------    
    ...
    if itrack==1
       ...
       if PLOT_START_LINE % added by kumano
