function [vo,vo_globalcoord] = get_velocityObstacle_othercars(mycar, othercar,varargin)
FLAG_DEBUG = false;
...
pB   = othercar.pos(1:2);
angB = othercar.pos(3);
vB   = othercar.vel(1)*[cos(toRadian(angB)), sin(toRadian(angB))];
%rB   = othercar.W*0.5;
rB   = (othercar.W+othercar.H)*0.25;
%-----------------------------
...
if dist_AB < rAB   
   dist_AB = rAB*1.05;  % very close case
end
