function othercars = addcars2_onRamp(othercars, track, nr_cars)
...
for carid = 1:nr_cars-1
    ...
    carpos = get_posintrack(track, carid*2, randoffset, laneidx, 0);
    %carpos = get_posintrack(track, segidx, randoffset, laneidx, 0);
    
%    othercars = add_othercars(othercars, carpos, [15000 0], 'normal');
    othercars = add_othercars(othercars, carpos, [12500 0], 'normal'); % 10000 mm/s = 36 km/h
