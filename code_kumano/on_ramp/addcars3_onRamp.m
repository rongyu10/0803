function othercars = addcars3_onRamp(othercars, track, nr_cars)
...
for carid = 1:nr_cars-1
    ...
    interval_seg = floor(track.nr_seg/(nr_cars-1));
    segidx = (carid-1)*interval_seg + 2;
...
%    othercars = add_othercars(othercars, carpos, [15000 0], 'normal');
    othercars = add_othercars(othercars, carpos, [22200 0], 'normal'); % 10000 mm/s = 36 km/h
...
carpos = get_posintrack(track, segidx, randoffset, laneidx, 0);
othercars = add_othercars(othercars, carpos, [0 0], 'stop');
othercars.car{othercars.n}.pos(2) = othercars.car{othercars.n}.pos(2) +500;
end
