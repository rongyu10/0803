...
sim       = init_sim(0.03); % dt = 0.02 [sec]
%------------------
%--- set othercars
othercars  = init_othercars();
nr_cars    = 20;  % 11
othercars  = addcars_tollplaza(othercars, road.track{1}, nr_cars);
%---------------
%--- set mycar--
ini_vel    = [20000 0];
...
while sim.flag && ishandle(fig)
    ...
    switch sim.mode 
        case 'RUN'
            ...
            othercars = intelligentDriverModel3(othercars,mycar,myinfo,road,sim);
