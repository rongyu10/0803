...
Kinematic = [25000, (40.0)/180*pi, 5000, (40.0)/180*pi,200, (1)/180*pi];
...
roadx = 275*10^3:500:(road.xmax);
for i=1:length(roadx)
    road_data=[road_data;roadx(i) 50*10^3];        
end
%-----------------------------
...
while sim.flag && ishandle(fig)
    ...
    switch sim.mode 
        case 'RUN'
            ...
            othercars = intelligentDriverModel3(othercars,mycar,[],road,sim);
...
%                   end
                    ...
                    if mycar.pos(1)< 250*10^3
                       evalParam = [40.0,200.0,20.0,2.5];  % [0.1,0.45,0.1,4.0]
                    else
                       evalParam = [150.0,50.0,150.0,2.5];  % [0.1,0.45,0.1,4.0]
