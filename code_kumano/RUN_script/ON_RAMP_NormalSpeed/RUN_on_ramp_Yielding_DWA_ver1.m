...
evalParam = [5.0,50.0,25.0,3.0];  % [0.1,0.45,0.1,4.0]
area      = [track.xmin, track.xmax, track.ymin, track.ymax];
%============================================================
%---road data-----------------
roadx = 0:500:250000;
road=[];
...
for i=1:length(roadx)
    ...
    road=[road;roadx(i) 3000];    
    road=[road;roadx(i) -7000];    
end
%}
for i=1:length(roadx)
