...
evalParam = [20.0,50.0,20.0,3.5]; % [0.1,0.45,0.1,4.0]
...
%                   end
                ...
                if FLAG_LANECHANGE==1
                    ...
                    [~,traj_DWA, eval_DWA] = Control_by_DynamicWindowApproach(mycar,[], sim, goal,all_obstacle,obstacleR, Kinematic, evalParam, area, PLOT_DWA, FLAG_methodDWA);
                end
            end
