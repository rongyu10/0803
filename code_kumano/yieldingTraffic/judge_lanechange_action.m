function [flag_LC, data_LC] = judge_lanechange_action(mycar, myinfo, othercars, sim, data_LC, flag_congested)
%
% 
...
if (idx_front ~=0)&&(idx_rear ~=0)
    ...
    if (diff_pos1 > (mycar.W)*ratio_carLength)&&(diff_pos2 > (mycar.W)*ratio_carLength)&&(accele_by_mycar> -1000)
       flag_LC = 1;
       return
    else
       flag_LC = 0;
