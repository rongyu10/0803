...
while sim.flag && ishandle(fig)
    ...
    switch key_pressed 
        ...
        case {'uparrow', 'leftbracket'}
            ...
            mycar.target_lane = mycar.tolllane - 1;
    ...
    switch sim.mode 
        case 'RUN'
            ...
            mycar = update_control_mycar_merge_intelligent(mycar, sim, othercars, idm, laneChangePath, lengthP, FLAG_LANECHANGE);
    ...
    plot_othercars_lanechange(othercars, SIMPLECARSHAPE, REALCARSHAPE, mycar.target_lane);
