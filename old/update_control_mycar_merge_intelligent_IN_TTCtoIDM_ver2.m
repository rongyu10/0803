function mycar = update_control_mycar_merge_intelligent_IN_TTCtoIDM_ver2(mycar, sim, othercars, idm, laneChangePath, lengthP, FLAG_LANECHANGE)
...
if first_flag1 && FLAG_LANECHANGE == 1
    ...
    h.ratioSpeed_tar = lengthP{target_lane, start_lane}/(175*10^3);
...
elseif first_flag && mycar.pos(1) > 100*10^3 % if mycar enters the plaza
    first_flag = false;
    ratioSpeed_cur = lengthP{mycar.goallane, mycar.startlane}/(175*10^3);
