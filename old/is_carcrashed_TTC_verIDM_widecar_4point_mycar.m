function [idx_crashcar, t_crashcar, pos_crashcar] = is_carcrashed_TTC_verIDM_widecar_4point_mycar(othercars, idx, time_TTC, step_TTC, mycar)
    ...
    for t = 0:step_TTC:time_TTC
        if(~isempty(idx_nearCar))
            ...
            for i = 1:nr_cars
                ...
                flgCollide = 0;
                for idx_point = 1:4
                    if norm(mycar_bdEst(idx_point,:) - othercars_posEst(1:2)) < 2500
                        flgCollide = 1;
                        break;
                    end
                end
                ...
                %----
                if flgCollide == 1 && othercars.car{idx}.pos(1) < othercars.car{idx_nearCar(i)}.pos(1)
