...
%---------------
%--- set mycar--
ini_vel    = [0 0];  % 10000 mm/s = 36 km/h
ini_pos    = [0 37500 0];
...
%             othercars  = update_othercars(othercars, sim);
            ...
            othercars  = update_control_othercars_mycar_intelligent_OUT_TTCtoIDM_ver2(othercars, sim, mycar, idm, laneChangePath, lengthP, FLAG_LANECHANGE);
    ...
    plot_arrow_selectlane_OUT(mycar.selectlane);
